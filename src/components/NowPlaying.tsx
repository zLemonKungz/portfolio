    ...
    <AnimatePresence>
      {showTrack && (
        <motion.a
          ...
          className="fixed bottom-4 sm:bottom-6 left-4 sm:left-6 z-40 flex items-center gap-2.5 px-3 py-2 rounded-full shadow-lg backdrop-blur-md border transition-all duration-300 hover:scale-105 hover:shadow-xl group"
          style={{
